...
const coaches = [
  {
    name: 'Aung La N Sang',
    description:
      'Born in Myanmar, he currently competes in both the middleweight and light heavyweight divisions.',
  ...
  },
  {
    ...
    description:
      'The current ONE Light Heavyweight Champion and ONE Heavyweight World Champion',
  ...
  },
  {
    ...
    description:
      'He currently competes in ONE Championship and is the reigning ONE Flyweight Muay Thai World Champion.',
  ...
  },
  {
    name: 'Christian Lee',
    description:
      "Lee is the fourth two-division champion in ONE history and holds the promotion's records for most wins (17), most finishes (16), and most knockouts (12).",
